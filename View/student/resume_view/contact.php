...
<ul class="list-unstyled contact-list">
    ...
    <li class="fb"><i class="fa fa-facebook"></i>
        <a href="<?php echo $con['facebook']; ?>"><?php echo $con['facebook']; ?></a></li>
    <?php }//end if 
    
        if (isset($con['instagram']) && $con['instagram']!='') {?>
    <li><i class="fa fa-instagram"></i>
        <a href="<?php echo $con['instagram']; ?>"><?php echo $con['instagram']; ?></a></li>
    <?php }//end if 
    
        if (isset($con['twitter']) && $con['twitter']!='') {?>
    <li><i class="fa fa-twitter"></i>
        <a href="<?php echo $con['twitter']; ?>"><?php echo $con['twitter']; ?></a></li>
    <?php }//end if 
    
        if (isset($con['youtube']) && $con['youtube']!='') {?>
    <li><i class="fa fa-youtube"></i>
        <a href="<?php echo $con['youtube']; ?>"><?php echo $con['youtube']; ?></a></li> 
    <?php }//end if ?>
</ul>
<?php }
